...
export function CandidateAssignmentDialog({
  ...
  const assignMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setFormData({ assignedToUserId: null, reason: '' });
      onOpenChange(false);
    },
  });
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="reason"
                placeholder="Why are you assigning this candidate to this team member?"
            ...
            {assignMutation.isSuccess && (
              <Alert>
                <AlertDescription>
                  Candidate successfully assigned! The team member will be notified.
                </AlertDescription>
              </Alert>
            )}
          </div>
          ...
          <DialogFooter>
            ...
            <Button
              type="submit"
              disabled={!formData.assignedToUserId || assignMutation.isPending}
            >
