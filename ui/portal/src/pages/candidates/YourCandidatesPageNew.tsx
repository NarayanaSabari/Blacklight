            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <span className="text-2xl font-bold">{currentCandidates.length}</span>
                    <span className="text-sm text-muted-foreground ml-1.5">Assigned to You</span>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {isLoadingOwnCandidates ? (
                ...
                currentCandidates.map((candidate) => (
                  <Card
                    key={candidate.id}
                    className="hover:shadow-lg transition-all hover:border-primary/50 group cursor-pointer border"
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="h-[calc(100vh-12rem)] flex flex-col">
              <CardHeader className="border-b bg-slate-50/50 flex-shrink-0 py-4">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-2">
                {!selectedMemberId ? (
                  ...
                  currentCandidates.map((candidate) => (
                    <Card 
                      key={candidate.id} 
                      className="hover:shadow-lg transition-all hover:border-primary/50 cursor-pointer group border"
                      onClick={() => handleViewCandidate(candidate.id)}
                    >
                      <CardContent className="p-4">
                        <div className="flex items-start justify-between">
