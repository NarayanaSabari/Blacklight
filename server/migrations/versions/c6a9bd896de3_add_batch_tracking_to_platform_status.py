...
def upgrade() -> None:
    ...
    op.drop_index(op.f('nc_sort_v2_base_id_index'), table_name='nc_sort_v2')
    op.drop_index(op.f('nc_sort_v2_fk_column_id_index'), table_name='nc_sort_v2')
    op.drop_index(op.f('nc_sort_v2_fk_view_id_index'), table_name='nc_sort_v2')
    op.drop_table('nc_sort_v2')
    op.drop_index(op.f('nc_hooks_v2_base_id_index'), table_name='nc_hooks_v2')
    op.drop_index(op.f('nc_hooks_v2_fk_model_id_index'), table_name='nc_hooks_v2')
    op.drop_table('nc_hooks_v2')
    op.drop_index(op.f('nc_kanban_view_v2_base_id_index'), table_name='nc_kanban_view_v2')
    op.drop_index(op.f('nc_kanban_view_v2_fk_grp_col_id_index'), table_name='nc_kanban_view_v2')
    op.drop_index(op.f('nc_kanban_view_v2_fk_view_id_index'), table_name='nc_kanban_view_v2')
    op.drop_table('nc_kanban_view_v2')
    op.drop_index(op.f('nc_widgets_context'), table_name='nc_widgets_v2')
    op.drop_index(op.f('nc_widgets_dashboard_idx'), table_name='nc_widgets_v2')
    op.drop_table('nc_widgets_v2')
    op.drop_index(op.f('nc_shared_views_v2_fk_view_id_index'), table_name='nc_shared_views_v2')
    op.drop_table('nc_shared_views_v2')
    op.drop_index(op.f('nc_base_users_v2_base_id_index'), table_name='nc_base_users_v2')
    op.drop_index(op.f('nc_base_users_v2_invited_by_index'), table_name='nc_base_users_v2')
    op.drop_index(op.f('nc_project_users_v2_fk_user_id_index'), table_name='nc_base_users_v2')
    op.drop_table('nc_base_users_v2')
    op.drop_index(op.f('nc_col_select_options_v2_base_id_index'), table_name='nc_col_select_options_v2')
    ...
    op.drop_index(op.f('nc_col_relations_v2_base_id_index'), table_name='nc_col_relations_v2')
    op.drop_index(op.f('nc_col_relations_v2_fk_child_column_id_index'), table_name='nc_col_relations_v2')
    op.drop_index(op.f('nc_col_relations_v2_fk_column_id_index'), table_name='nc_col_relations_v2')
    op.drop_index(op.f('nc_col_relations_v2_fk_mm_child_column_id_index'), table_name='nc_col_relations_v2')
    op.drop_index(op.f('nc_col_relations_v2_fk_mm_model_id_index'), table_name='nc_col_relations_v2')
    op.drop_index(op.f('nc_col_relations_v2_fk_mm_parent_column_id_index'), table_name='nc_col_relations_v2')
    op.drop_index(op.f('nc_col_relations_v2_fk_parent_column_id_index'), table_name='nc_col_relations_v2')
    op.drop_index(op.f('nc_col_relations_v2_fk_related_model_id_index'), table_name='nc_col_relations_v2')
    op.drop_index(op.f('nc_col_relations_v2_fk_target_view_id_index'), table_name='nc_col_relations_v2')
    op.drop_table('nc_col_relations_v2')
    op.drop_index(op.f('nc_store_key_index'), table_name='nc_store')
    op.drop_table('nc_store')
    op.drop_index(op.f('nc_audit_v2_fk_workspace_idx'), table_name='nc_audit_v2')
    op.drop_index(op.f('nc_audit_v2_old_id_index'), table_name='nc_audit_v2')
    op.drop_index(op.f('nc_audit_v2_tenant_idx'), table_name='nc_audit_v2')
    op.drop_index(op.f('nc_record_audit_v2_tenant_idx'), table_name='nc_audit_v2')
    op.drop_table('nc_audit_v2')
    op.drop_table('xc_knex_migrationsv2')
    op.drop_index(op.f('nc_map_view_v2_base_id_index'), table_name='nc_map_view_v2')
    op.drop_index(op.f('nc_map_view_v2_fk_geo_data_col_id_index'), table_name='nc_map_view_v2')
    op.drop_index(op.f('nc_map_view_v2_fk_view_id_index'), table_name='nc_map_view_v2')
    op.drop_table('nc_map_view_v2')
    op.drop_index(op.f('nc_integrations_v2_created_by_index'), table_name='nc_integrations_v2')
    op.drop_index(op.f('nc_integrations_v2_type_index'), table_name='nc_integrations_v2')
    op.drop_table('nc_integrations_v2')
    op.drop_index(op.f('nc_calendar_view_columns_v2_base_id_index'), table_name='nc_calendar_view_columns_v2')
    op.drop_index(op.f('nc_calendar_view_columns_v2_fk_view_id_fk_column_id_index'), table_name='nc_calendar_view_columns_v2')
    op.drop_table('nc_calendar_view_columns_v2')
    op.drop_index(op.f('nc_hook_logs_v2_base_id_index'), table_name='nc_hook_logs_v2')
    op.drop_table('nc_hook_logs_v2')
    op.drop_index(op.f('nc_sync_logs_v2_base_id_index'), table_name='nc_sync_logs_v2')
    op.drop_table('nc_sync_logs_v2')
    op.drop_index(op.f('nc_user_comment_notifications_preference_base_id_index'), table_name='nc_user_comment_notifications_preference')
    op.drop_index(op.f('user_comments_preference_index'), table_name='nc_user_comment_notifications_preference')
    op.drop_table('nc_user_comment_notifications_preference')
    op.drop_index(op.f('nc_integrations_store_v2_fk_integration_id_index'), table_name='nc_integrations_store_v2')
    op.drop_table('nc_integrations_store_v2')
    op.drop_table('nc_team_users_v2')
    op.drop_index(op.f('notification_created_at_index'), table_name='notification')
    op.drop_index(op.f('notification_fk_user_id_index'), table_name='notification')
    op.drop_table('notification')
    op.drop_index(op.f('nc_row_color_conditions_fk_view_id_index'), table_name='nc_row_color_conditions')
    op.drop_index(op.f('nc_row_color_conditions_fk_workspace_id_base_id_index'), table_name='nc_row_color_conditions')
    op.drop_table('nc_row_color_conditions')
    op.drop_index(op.f('nc_data_reflection_fk_workspace_id_index'), table_name='nc_data_reflection')
    op.drop_table('nc_data_reflection')
    op.drop_table('xc_knex_migrations')
    op.drop_index(op.f('nc_fr_context'), table_name='nc_file_references')
    op.drop_table('nc_file_references')
    op.drop_table('nc_plugins_v2')
    op.drop_index(op.f('nc_jobs_context'), table_name='nc_jobs')
    op.drop_table('nc_jobs')
    op.drop_index(op.f('nc_form_view_v2_base_id_index'), table_name='nc_form_view_v2')
    op.drop_index(op.f('nc_form_view_v2_fk_view_id_index'), table_name='nc_form_view_v2')
    op.drop_table('nc_form_view_v2')
    op.drop_index(op.f('nc_gallery_view_columns_v2_base_id_index'), table_name='nc_gallery_view_columns_v2')
    op.drop_index(op.f('nc_gallery_view_columns_v2_fk_column_id_index'), table_name='nc_gallery_view_columns_v2')
    op.drop_index(op.f('nc_gallery_view_columns_v2_fk_view_id_fk_column_id_index'), table_name='nc_gallery_view_columns_v2')
    op.drop_index(op.f('nc_gallery_view_columns_v2_fk_view_id_index'), table_name='nc_gallery_view_columns_v2')
    op.drop_table('nc_gallery_view_columns_v2')
    op.drop_index(op.f('nc_col_rollup_v2_base_id_index'), table_name='nc_col_rollup_v2')
    op.drop_index(op.f('nc_col_rollup_v2_fk_column_id_index'), table_name='nc_col_rollup_v2')
    op.drop_index(op.f('nc_col_rollup_v2_fk_relation_column_id_index'), table_name='nc_col_rollup_v2')
    op.drop_index(op.f('nc_col_rollup_v2_fk_rollup_column_id_index'), table_name='nc_col_rollup_v2')
    op.drop_table('nc_col_rollup_v2')
    op.drop_index(op.f('nc_user_refresh_tokens_expires_at_index'), table_name='nc_user_refresh_tokens')
    op.drop_index(op.f('nc_user_refresh_tokens_fk_user_id_index'), table_name='nc_user_refresh_tokens')
    op.drop_index(op.f('nc_user_refresh_tokens_token_index'), table_name='nc_user_refresh_tokens')
    op.drop_table('nc_user_refresh_tokens')
    op.drop_index(op.f('nc_sync_mappings_context'), table_name='nc_sync_mappings')
    op.drop_index(op.f('nc_sync_mappings_sync_config_idx'), table_name='nc_sync_mappings')
    op.drop_table('nc_sync_mappings')
    op.drop_index(op.f('nc_col_qrcode_v2_base_id_index'), table_name='nc_col_qrcode_v2')
    op.drop_index(op.f('nc_col_qrcode_v2_fk_column_id_index'), table_name='nc_col_qrcode_v2')
    op.drop_table('nc_col_qrcode_v2')
    op.drop_index(op.f('nc_col_barcode_v2_base_id_index'), table_name='nc_col_barcode_v2')
    op.drop_index(op.f('nc_col_barcode_v2_fk_column_id_index'), table_name='nc_col_barcode_v2')
    op.drop_table('nc_col_barcode_v2')
    op.drop_table('nc_teams_v2')
    op.drop_index(op.f('nc_comments_base_id_index'), table_name='nc_comments')
    op.drop_index(op.f('nc_comments_row_id_fk_model_id_index'), table_name='nc_comments')
    op.drop_table('nc_comments')
    op.drop_index(op.f('nc_comment_reactions_base_id_index'), table_name='nc_comment_reactions')
    op.drop_index(op.f('nc_comment_reactions_comment_id_index'), table_name='nc_comment_reactions')
    op.drop_index(op.f('nc_comment_reactions_row_id_index'), table_name='nc_comment_reactions')
    op.drop_table('nc_comment_reactions')
    op.drop_index(op.f('nc_col_button_context'), table_name='nc_col_button_v2')
    op.drop_index(op.f('nc_col_button_v2_fk_column_id_index'), table_name='nc_col_button_v2')
    op.drop_table('nc_col_button_v2')
    op.drop_index(op.f('nc_users_v2_email_index'), table_name='nc_users_v2')
    op.drop_table('nc_users_v2')
    op.drop_index(op.f('nc_grid_view_v2_base_id_index'), table_name='nc_grid_view_v2')
    op.drop_index(op.f('nc_grid_view_v2_fk_view_id_index'), table_name='nc_grid_view_v2')
    op.drop_table('nc_grid_view_v2')
    op.drop_index(op.f('nc_col_formula_v2_base_id_index'), table_name='nc_col_formula_v2')
    op.drop_index(op.f('nc_col_formula_v2_fk_column_id_index'), table_name='nc_col_formula_v2')
    op.drop_table('nc_col_formula_v2')
    op.drop_index(op.f('nc_mc_tokens_context'), table_name='nc_mcp_tokens')
    op.drop_table('nc_mcp_tokens')
    op.drop_index(op.f('nc_views_v2_base_id_index'), table_name='nc_views_v2')
    op.drop_index(op.f('nc_views_v2_created_by_index'), table_name='nc_views_v2')
    op.drop_index(op.f('nc_views_v2_fk_model_id_index'), table_name='nc_views_v2')
    op.drop_index(op.f('nc_views_v2_owned_by_index'), table_name='nc_views_v2')
    op.drop_table('nc_views_v2')
    op.drop_index(op.f('nc_filter_exp_v2_base_id_index'), table_name='nc_filter_exp_v2')
    op.drop_index(op.f('nc_filter_exp_v2_fk_column_id_index'), table_name='nc_filter_exp_v2')
    op.drop_index(op.f('nc_filter_exp_v2_fk_hook_id_index'), table_name='nc_filter_exp_v2')
    op.drop_index(op.f('nc_filter_exp_v2_fk_link_col_id_index'), table_name='nc_filter_exp_v2')
    op.drop_index(op.f('nc_filter_exp_v2_fk_parent_column_id_index'), table_name='nc_filter_exp_v2')
    op.drop_index(op.f('nc_filter_exp_v2_fk_parent_id_index'), table_name='nc_filter_exp_v2')
    op.drop_index(op.f('nc_filter_exp_v2_fk_value_col_id_index'), table_name='nc_filter_exp_v2')
    op.drop_index(op.f('nc_filter_exp_v2_fk_view_id_index'), table_name='nc_filter_exp_v2')
    op.drop_index(op.f('nc_filter_exp_v2_fk_widget_id_index'), table_name='nc_filter_exp_v2')
    op.drop_table('nc_filter_exp_v2')
    op.drop_index(op.f('nc_kanban_view_columns_v2_base_id_index'), table_name='nc_kanban_view_columns_v2')
    op.drop_index(op.f('nc_kanban_view_columns_v2_fk_column_id_index'), table_name='nc_kanban_view_columns_v2')
    op.drop_index(op.f('nc_kanban_view_columns_v2_fk_view_id_fk_column_id_index'), table_name='nc_kanban_view_columns_v2')
    op.drop_index(op.f('nc_kanban_view_columns_v2_fk_view_id_index'), table_name='nc_kanban_view_columns_v2')
    op.drop_table('nc_kanban_view_columns_v2')
    op.drop_index(op.f('nc_form_view_columns_v2_base_id_index'), table_name='nc_form_view_columns_v2')
    op.drop_index(op.f('nc_form_view_columns_v2_fk_column_id_index'), table_name='nc_form_view_columns_v2')
    op.drop_index(op.f('nc_form_view_columns_v2_fk_view_id_fk_column_id_index'), table_name='nc_form_view_columns_v2')
    op.drop_index(op.f('nc_form_view_columns_v2_fk_view_id_index'), table_name='nc_form_view_columns_v2')
    op.drop_table('nc_form_view_columns_v2')
    op.drop_index(op.f('nc_col_lookup_v2_base_id_index'), table_name='nc_col_lookup_v2')
    op.drop_index(op.f('nc_col_lookup_v2_fk_column_id_index'), table_name='nc_col_lookup_v2')
    op.drop_index(op.f('nc_col_lookup_v2_fk_lookup_column_id_index'), table_name='nc_col_lookup_v2')
    op.drop_index(op.f('nc_col_lookup_v2_fk_relation_column_id_index'), table_name='nc_col_lookup_v2')
    op.drop_table('nc_col_lookup_v2')
    op.drop_table('xc_knex_migrations_lock')
    op.drop_table('nc_orgs_v2')
    op.drop_index(op.f('nc_columns_v2_base_id_index'), table_name='nc_columns_v2')
    op.drop_index(op.f('nc_columns_v2_fk_model_id_index'), table_name='nc_columns_v2')
    op.drop_table('nc_columns_v2')
    op.drop_index(op.f('nc_extensions_base_id_index'), table_name='nc_extensions')
    op.drop_table('nc_extensions')
    op.drop_table('nc_shared_bases')
    op.drop_index(op.f('nc_gallery_view_v2_base_id_index'), table_name='nc_gallery_view_v2')
    op.drop_index(op.f('nc_gallery_view_v2_fk_view_id_index'), table_name='nc_gallery_view_v2')
    op.drop_table('nc_gallery_view_v2')
    op.drop_index(op.f('nc_sync_configs_context'), table_name='nc_sync_configs')
    op.drop_index(op.f('nc_sync_configs_parent_idx'), table_name='nc_sync_configs')
    op.drop_index(op.f('sync_configs_integration_model'), table_name='nc_sync_configs')
    op.drop_table('nc_sync_configs')
    op.drop_index(op.f('nc_calendar_view_v2_base_id_index'), table_name='nc_calendar_view_v2')
    op.drop_table('nc_calendar_view_v2')
    op.drop_index(op.f('nc_map_view_columns_v2_base_id_index'), table_name='nc_map_view_columns_v2')
    op.drop_index(op.f('nc_map_view_columns_v2_fk_column_id_index'), table_name='nc_map_view_columns_v2')
    op.drop_index(op.f('nc_map_view_columns_v2_fk_view_id_fk_column_id_index'), table_name='nc_map_view_columns_v2')
    op.drop_index(op.f('nc_map_view_columns_v2_fk_view_id_index'), table_name='nc_map_view_columns_v2')
    op.drop_table('nc_map_view_columns_v2')
    op.drop_index(op.f('nc_sync_source_v2_base_id_index'), table_name='nc_sync_source_v2')
    op.drop_index(op.f('nc_sync_source_v2_source_id_index'), table_name='nc_sync_source_v2')
    op.drop_table('nc_sync_source_v2')
    op.drop_index(op.f('nc_calendar_view_range_v2_base_id_index'), table_name='nc_calendar_view_range_v2')
    op.drop_table('nc_calendar_view_range_v2')
    op.drop_index(op.f('nc_col_long_text_context'), table_name='nc_col_long_text_v2')
    op.drop_index(op.f('nc_col_long_text_v2_fk_column_id_index'), table_name='nc_col_long_text_v2')
    op.drop_table('nc_col_long_text_v2')
    op.drop_index(op.f('nc_grid_view_columns_v2_base_id_index'), table_name='nc_grid_view_columns_v2')
    op.drop_index(op.f('nc_grid_view_columns_v2_fk_column_id_index'), table_name='nc_grid_view_columns_v2')
    op.drop_index(op.f('nc_grid_view_columns_v2_fk_view_id_fk_column_id_index'), table_name='nc_grid_view_columns_v2')
    op.drop_index(op.f('nc_grid_view_columns_v2_fk_view_id_index'), table_name='nc_grid_view_columns_v2')
    op.drop_table('nc_grid_view_columns_v2')
    op.drop_index(op.f('nc_audit_v2_base_id_index'), table_name='nc_audit_v2_old')
    op.drop_index(op.f('nc_audit_v2_fk_model_id_index'), table_name='nc_audit_v2_old')
    op.drop_index(op.f('nc_audit_v2_row_id_index'), table_name='nc_audit_v2_old')
    op.drop_table('nc_audit_v2_old')
    op.drop_table('nc_bases_v2')
    op.drop_table('nc_hook_trigger_fields')
    op.drop_index(op.f('nc_disabled_models_for_role_v2_base_id_index'), table_name='nc_disabled_models_for_role_v2')
    op.drop_index(op.f('nc_disabled_models_for_role_v2_fk_view_id_index'), table_name='nc_disabled_models_for_role_v2')
    op.drop_table('nc_disabled_models_for_role_v2')
    op.drop_index(op.f('nc_sources_v2_base_id_index'), table_name='nc_sources_v2')
    op.drop_index(op.f('nc_sources_v2_fk_integration_id_index'), table_name='nc_sources_v2')
    op.drop_table('nc_sources_v2')
    op.drop_index(op.f('nc_models_v2_base_id_index'), table_name='nc_models_v2')
    op.drop_index(op.f('nc_models_v2_source_id_index'), table_name='nc_models_v2')
    op.drop_index(op.f('nc_models_v2_type_index'), table_name='nc_models_v2')
    op.drop_index(op.f('nc_models_v2_uuid_index'), table_name='nc_models_v2')
    op.drop_table('nc_models_v2')
    op.drop_table('xc_knex_migrationsv2_lock')
    op.drop_index(op.f('nc_api_tokens_fk_sso_client_id_index'), table_name='nc_api_tokens')
    op.drop_index(op.f('nc_api_tokens_fk_user_id_index'), table_name='nc_api_tokens')
    op.drop_table('nc_api_tokens')
    op.drop_index(op.f('nc_permissions_context'), table_name='nc_permissions')
    op.drop_index(op.f('nc_permissions_entity'), table_name='nc_permissions')
    op.drop_table('nc_permissions')
    op.drop_index(op.f('nc_dashboards_context'), table_name='nc_dashboards_v2')
    op.drop_index(op.f('share_uuid_idx'), table_name='nc_dashboards_v2')
    op.drop_table('nc_dashboards_v2')
    op.drop_index(op.f('nc_permission_subjects_context'), table_name='nc_permission_subjects')
    op.drop_table('nc_permission_subjects')
